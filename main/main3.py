...
class PodcastTranscriptProcessor:
    ...
    def content_refinement_agent(self, state: State) -> State:
        refinement_prompt = ChatPromptTemplate.from_messages([
            ...
            1. Your persona is of a Viewer who likes to watch podcast videos, you have access to the orignal transcript as well as the segments from the previous step.
            2. The segments from the previous step is selected segments from a video editor's perspective.
            ...
            3. Then compare the results with segments from the previous step and make sure the content is accurate. For this task use the segments from the previous step.
            4. Remove unwanted words and profanity
            5. Maintain exact timestamps
            6. Do not modify core content of the transcript
        ...
        try:
            refined_segments = refinement_chain.invoke(input={
                "segments": state['segments'],"transcript": state['transcript']
            })
    ...
    def timestamp_precision_agent(self, state: State) -> Dict[str, Any]:
        ...
        precision_prompt = ChatPromptTemplate.from_messages([
            ...
            DO NOT give anything other than the timestamps, potential score, title, in the output.
