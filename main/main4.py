...
class ParallelTranscriptProcessor:
    def __init__(self):
        ...
        # Initialize separate graphs for each workflow
    ...
    def combiner_agent(self, state: CombinedState) -> CombinedState:
        ...
        try:
            ...
            return {
                **state,
                "messages": [*state['messages'], AIMessage(content=str(combined))],
    ...
    def formatter_agent(self, state: CombinedState) -> CombinedState:
        ...
        try:
            ...
            return {
                **state,
                "messages": [*state['messages'], AIMessage(content=str(formatted))],
...
def main():
    ...
    with open("script_output.txt", 'w') as file:
        file.write(result["final_output"].content)
